...
const Footer = () => {
  return (
    <footer className="bg-secondary/50 dark:bg-gray-900/50 py-12 mt-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block text-gradient">
              LearningLift
            </Link>
            <p className="text-sm text-muted-foreground">
              Revolutionizing education with AI-powered learning tools for students and educators.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/assistant" className="text-sm hover:text-primary transition-colors">Virtual Assistant</Link></li>
              <li><Link to="/note-taker" className="text-sm hover:text-primary transition-colors">Note Taker</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/support" className="text-sm hover:text-primary transition-colors">Support</Link></li>
              <li><Link to="/docs" className="text-sm hover:text-primary transition-colors">Documentation</Link></li>
              <li><Link to="/updates" className="text-sm hover:text-primary transition-colors">Updates</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} LearningLift. All rights reserved.
          </p>
